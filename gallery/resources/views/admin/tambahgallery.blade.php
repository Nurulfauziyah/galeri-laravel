...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item"> <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a> </li>
      <li class="nav-item d-none d-sm-inline-block active">
        <a href="/admin/udahlogin" class="nav-link">Beranda</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block active">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Galeri Uci</span>
    </a>
            ...
            <div class="card card-secondary">
              ...
              <form method="POST" action="{{ route('simpanGallery') }}" id="myForm" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Foto" name="nama">
                  </div>
                  <div class="form-group">
